...
BunnyFormData.prototype.getInputType = function getInputType(name_or_el) {
    var input = null;
    if ((typeof name_or_el === 'undefined' ? 'undefined' : _typeof$1(name_or_el)) === 'object') {
        input = name_or_el;
    } else {
...
BunnyFormData.prototype.isNodeList = function isNodeList(input_name_or_el) {
    var input = (typeof input_name_or_el === 'undefined' ? 'undefined' : _typeof$1(input_name_or_el)) === 'object' ? input_name_or_el : this.getInput(input_name_or_el);
