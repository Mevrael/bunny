...
export var CalendarDecorator = {
    ...
    decorateTableBody: function(tbody, row_collection, td_collection, inactive_td_collection, current_td) {
...
export var Calendar = {
    ...
    create: function(id = 'datepicker', min_year = 1950, max_year = 2050, year = null, month_index = null, day = null) {
        ...
        CalendarDecorator.decorateTableBody(table_body.tbody, table_body.rowCollection, table_body.tdCollection, table_body.inactiveTdCollection, table_body.currentTd);
    ...
    pickDay: function(calendar_id, year, month_index, day) {
        ...
        for (var i = 0; i < this._calendars[calendar_id].onPickHandlers.length; i++) {
            this._calendars[calendar_id].onPickHandlers[i](year, month_index + 1, day);
        }
    },
